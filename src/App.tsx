    ...
    <div className="layout">
      ...
      <div className="page">
        ...
        <Routes>
          ...
          <Route path="/clients/:contentId"      element={<ClientDetailPage kind="client" />} />
          <Route path="/mods/:contentId"         element={<ClientDetailPage kind="mod" />} />
          <Route path="/skins/:contentId"        element={<ClientDetailPage kind="skin" />} />
