...
function Sidebar() {
  ...
  const rs = user
    ? ROLE_STYLE[user.role] ?? ROLE_STYLE.user
    : ROLE_STYLE.user;
          ...
          >
            <img
              src={`https://api.dicebear.com/7.x/initials/svg?seed=${encodeURIComponent(
                user.name
              )}&backgroundColor=4f7cff&textColor=ffffff`}
              alt={user.name}
    ...
    <div className="layout">
      ...
      <div className="page">
        ...
        <Routes>
          ...
          <Route
            path="/clients"
            element={<BrowserPage kind="client" />}
          />

          {/* NEW: Client Details Route */}
          <Route
            path="/client/:contentId"
            element={<ClientDetailPage />}
          />

          <Route
            path="/mods"
            element={<BrowserPage kind="mod" />}
          />

          <Route
            path="/skins"
            element={<BrowserPage kind="skin" />}
          />
